...
<html lang="en">
<head>
<title>The Epsilon- Home</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="keywords" content="Robotics Club IIT Bhilai">
...
<div class="container-l-n">
  ...
  <div class="logo-navigation">
    <a href="index.html"><img class="l" src="images/epsilon-logo.jpg" alt="Epsilon Logo"></a>
    </div>
    <div class="tog-mob">
      <label class="btn-toggle" for="toggle">&#9776;</label>
      <input type="checkbox" id="toggle"  />
      <nav class="menu">
        <ul>
          <li>  <a href="index.html#home">Home</a></li>

          <li class="events"><a>Events <i class="fas fa-angle-down"></i></a>
            <ul>
              <li> <a href= "meraz-18.html">Meraz'18</a></li>
              <li><a href="meraz-19.html">Meraz'19</a></li>
              <li> <a href= "tech-maitry.html">Tech Maitry</a></li>
              <li> <a class="nav_robo" href= "robo-carnival-18.html">Carnival'18</a></li>
              <li><a href="robo-carnival-20.html">Carnival'20</a></li>
            </ul>
          </li>
          ...
          <div class="name">
            ...
            <div class="row2">
              ...
              <figure class="founder-image">
                ...
                <div class="hover-name">
                <h3>Blobhit<br/> Kumar<br />Behera</h3>
                </div>
                </figure>
  ...
  <div class="contact" id="contact">
    <div class="contact-us">
      <p class="c-us">
        ...
        <div class="icon">
          <ul >
            <li >
                <a class="fb" href="https://www.facbook.com/epsiloniitbh/" target="_blank" ><i class="fa fa-facebook-square" aria-hidden="true"></i></a>

            </li>
            <li >
              <a class="insta" href="https://www.instagram.com/roboticsiitbhilai" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </li>
          </ul>
        </div>
        <br>
    ...
    <div class="icon">
      <ul>
          ...
          <li><i class="fa fa-phone"></i><pre> +91-7786875370  </pre> </li>
          <li>
            <a class="mail" href="mailto:abhinava@iitbhilai.ac.in"><i class="fa fa-envelope"> </i></a> abhinava@iitbhilai.ac.in</li>
          <li>
          <br/>
            <a class="fill_frm" href="https://docs.google.com/forms/d/e/1FAIpQLSd4lwflmMRAeSK23Khmm90W4Pl8YkIwFvWY_hLK-7HqUVCg-g/viewform?embedded=true" target="open_"><button style="background-color:#091f9e;color:white;padding:10px;outline:none;border-radius:50%;font-size:20px;" onclick="change_display()" id="qry">Queries ?  &#9660;</button></a>
          </li>
...
<p class="paras" style="font-size:10px;">Updates 2020 by Abhinav Anand & Akash Narayan Mishra</p>
<div class="copyright" id="testt">
  &copy; Copyright The Epsilon, IIT Bhilai
</div>
<br>
         <iframe id="suggestion" style="display:none" name="open_">hssjskksk</iframe>
<script src="js/preloader.js"></script>
<script src="js/animate-index.js"></script>
 </body>
 </html>
